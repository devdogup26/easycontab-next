...
const usuarioNavItems = [
  { label: 'Dashboard', href: '/dashboard', icon: Home, code: null },
  {
    ...
    code: 'clientes:read',
    children: [
      { label: 'GOB 360°', href: '/dashboard/clientes' },
    ...
    <>
      ...
      <aside className={`${styles.sidebar} ${mobileOpen ? styles.mobileOpen : ''}`}>
        <div className={styles.logo}>
          ...
          <span className={styles.logoText}>GOB 360°</span>
        ...
        <div className={styles.footer}>
          {session?.user && (
            <div className={styles.user}>
              ...
              <span className={styles.userEmail}>{(session.user as any).contadorNome || 'Admin'}</span>
              {isAdmin && (
